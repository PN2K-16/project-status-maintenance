...
class DBController extends Controller
{
    ...
    public function getSearchcustomer(Request $request){
        ...
        $result=DB::table('customer_details')->where('cus_id',$cus_id)->get();
        return $result;
    }
    ...
    public function getSearchitem(Request $request){
        ...
        $result=DB::table('item_details')->leftJoin('inv_brands' , 'item_details.item_no','=','inv_brands.id')->where('brandname','like',$search.'%')->get();
        return $result;
    ...
    */
    ...
    public function getUpdatepoints(Request $request){
        ...
        DB::table('customer_details')->where('cus_id',$cusid)->increment('cus_points', $newlpoints);
    }
    ...
    public function getPreorderitems(Request $request){
        ...
        $result=DB::table('preorderitems')->where('preorder_id',$preorder_id)->get();
        return $result;
    }
   ...
   public function getUpdaterow(Request $request){
    ...
    public function getIndex() {
            ...
            $result=DB::table('customer_details')->get();
            return $result;
        }
    
    public function getCcompletepreorder(Request $request){
